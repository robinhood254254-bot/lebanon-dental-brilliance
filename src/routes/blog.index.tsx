...
export const Route = createFileRoute("/blog/")({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: absoluteImage(BLOG_POSTS[0].image) },
      { property: "og:url", content: `${SITE_URL}/blog` },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Dental Blog | Lebanon Dental Care" },
      { name: "twitter:description", content: "Expert dental tips and oral health advice." },
      { name: "twitter:image", content: absoluteImage(BLOG_POSTS[0].image) },
    ],

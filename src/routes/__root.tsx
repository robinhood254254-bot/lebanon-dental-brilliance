...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Lebanon Dental Care | Your Smile, Our Priority" },
      { name: "description", content: "Lebanon Dental Care — modern dental clinic with 10+ years of expertise providing braces, veneers, cleanings, root canals, emergency care and more." },
      { name: "author", content: "Lebanon Dental Care" },

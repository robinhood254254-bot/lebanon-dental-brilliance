...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Lebanon Dental Care Clinic | Your Smile, Our Priority" },
      { name: "description", content: "Lebanon Dental Care Clinic — modern dental clinic with 10+ years of expertise providing braces, veneers, cleanings, root canals, emergency care and more." },
      { name: "author", content: "Lebanon Dental Care Clinic" },
      { property: "og:type", content: "website" },
      { property: "og:title", content: "Lebanon Dental Care Clinic" },

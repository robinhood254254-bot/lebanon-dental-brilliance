...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Lebanon Dental Care Clinic — trusted Kenyan dental clinic with 10+ years of expertise. Affordable braces, veneers, teeth cleaning, root canals, extractions, children's dentistry and 24/7 emergency dental care. Book your appointment today." },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Lebanon Dental Care Clinic | Best Dentist in Kenya | Braces, Veneers & Emergency Care" },
      { name: "twitter:description", content: "Lebanon Dental Care Clinic — trusted Kenyan dental clinic with 10+ years of expertise. Affordable braces, veneers, teeth cleaning, root canals, extractions, children's dentistry and 24/7 emergency dental care. Book your appointment today." },
